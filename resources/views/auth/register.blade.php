                ...
                <div class="flex flex-col break-words bg-white border border-2 shadow-md mt-20">
                    ...
                    <form class="py-10 px-5" method="POST" action="{{ route('register') }}" novalidate>
                        ...
                        <div class="flex flex-wrap mb-6">
                            <label for="name" class="block text-teal-700 text-sm mb-2">{{ __('Name') }}</label>
    
                            <input id="name" type="text" class="p-3 bg-teal-200 rounded form-input w-full
                                        @error('name') border-red-500 border @enderror" name="name" value="{{ old('name') }}"
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="email" type="email" class="p-3 bg-teal-200 rounded form-input w-full 
                                    @error('email') border-red-500 border @enderror" name="email" value="{{ old('email') }}"
                                autocomplete="email">
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="password" type="password" class="p-3 bg-teal-200 rounded form-input w-full 
                                    @error('password') border-red-500 border @enderror" name="password"
                        ...
                        <div class="flex flex-wrap mb-6">
                            <label for="password-confirm"
                                class="block text-teal-700 text-sm mb-2">{{ __('Confirm Password') }}</label>
