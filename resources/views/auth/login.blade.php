                ...
                <form class="py-10 px-5" method="POST" action="{{ route('login') }}" novalidate>
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="email" type="email"
                            class="p-3 bg-teal-200 rounded form-input w-full @error('email') border-red-500 border @enderror"
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="password" type="password"
                            ...
                            @error('password') border-red-500 border @enderror"
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <label class="block text-teal-700 text-sm mb-2" for="remember">
                            {{ __('Remember Me') }}
                        </label>
                    </div>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <a class="text-sm text-teal-500 mt-5 text-center w-full" href="{{ route('password.request') }}">
